...
pub fn uses_decimal_comma(txt: &str, enforce_euro_mode: bool) -> bool {
...
mod tests {
    ...
    fn test_number_format_1() {
        let sample = "1.256";
        assert_eq!(uses_decimal_comma(sample, false), false);
    }
    ...
    fn test_number_format_3() {
        ...
        assert_eq!(uses_decimal_comma(sample, false), true);
    }
